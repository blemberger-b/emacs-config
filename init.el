...
(custom-set-variables
 ...
 '(package-selected-packages
   '(treemacs-projectile surround nodejs-repl urlenc lsp-mode protobuf-mode auto-dim-other-buffers org-bullets plantuml-mode general smex elisp-refs org-tree-slide projectile yaml-mode beacon markdown-mode async clojure-mode dash golden-ratio-scroll-screen gnu-elpa-keyring-update htmlize mwim goto-last-change diminish spaceline company rainbow-delimiters presentation sudo-edit paredit cider use-package))

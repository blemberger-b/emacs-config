...
(custom-set-variables
 ...
 '(package-selected-packages
   '(smex counsel with-editor elisp-refs page-break-lines org-tree-slide projectile yaml-mode beacon markdown-mode transient async clojure-mode dash golden-ratio-scroll-screen magit gnu-elpa-keyring-update htmlize mwim goto-last-change popup-kill-ring diminish spaceline company rainbow-delimiters presentation sudo-edit paredit cider which-key use-package))

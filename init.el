...
(custom-set-variables
 ...
 '(package-selected-packages
   '(nodejs-repl urlenc lsp-mode protobuf-mode auto-dim-other-buffers org-bullets pcre2el plantuml-mode general smex elisp-refs org-tree-slide projectile yaml-mode beacon markdown-mode transient async clojure-mode dash golden-ratio-scroll-screen magit gnu-elpa-keyring-update htmlize mwim goto-last-change diminish spaceline company rainbow-delimiters presentation sudo-edit paredit cider use-package))

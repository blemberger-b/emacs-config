...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (goto-last-change popup-kill-ring diminish spaceline company rainbow-delimiters presentation sudo-edit paredit cider avy ido-vertical-mode which-key use-package))))

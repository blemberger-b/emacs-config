...
*** Perl Compatile Regular Expressions
    ...
    somewhat limited. This package introduces support commands and built-in integration with
...
#+begin_src emacs-lisp
  (use-package general
    ...
    (general-define-key
     ...
     "C-c C-j" nil) ;; need to undefine any bindings to use as a prefix
    (general-create-definer bsl/control-c-definer
      :prefix "C-c")
    (general-create-definer bsl/control-c-control-j-definer
      :prefix "C-c C-j"))
#+end_src
*** Keybindings
...
#+begin_src emacs-lisp
  ...
  (bsl/control-c-control-j-definer
    "/" 'goto-last-change

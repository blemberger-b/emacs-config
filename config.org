...
#+begin_src emacs-lisp
  (bsl/control-c-definer :keymaps 'python-mode-map "M-j" 'eglot)
#+end_src
To disconnect and kill the LSP server, use this key:
#+begin_src emacs-lisp
  (bsl/control-c-definer :keymaps 'python-mode-map "M-q" 'eglot-shutdown)
#+end_src
** PEP 8 Reformatter
...
#+begin_src emacs-lisp
  (bsl/control-c-definer :keymaps 'python-mode-map "M-A" 'pyvenv-activate) ; prompt for virtual env
  (bsl/control-c-definer :keymaps 'python-mode-map "M-a" 'bsl/activate-uv-venv)
  (bsl/control-c-definer :keymaps 'python-mode-map "M-d" 'pyvenv-deactivate)
#+end_src
* Clojure

...
#+BEGIN_SRC emacs-lisp
  (use-package dashboard
    ...
    (dashboard-banner-logo-title
     "Ad astra per aspera.")
    (dashboard-item-shortcuts '((recents . "r") (projects . "j") (agenda . "a")))
    (dashboard-filter-agenda-entry 'dashboard-filter-agenda-by-todo)
    (dashboard-week-agenda nil)
    (dashboard-agenda-sort-strategy '(todo-state-down time-up)))
#+END_SRC
** Markdown
...
#+end_src
** Kill all non-Org-Agenda buffers
This command will kill all killable buffers. If any buffers have unsaved changes, you'll be prompted
to confirm. It will then open the =*dashboard*= buffer. Since the =*dashboard*= buffer shows an *Org
Agenda* view, if it's open we don't kill it or any of the =org-mode= files that =org-agenda= sources
from.
#+BEGIN_SRC emacs-lisp
  (defun bsl/kill-all-buffers ()
    ...
    (mapc 'kill-buffer
          (seq-filter
           (lambda (buf) (not (string= (buffer-name buf) "*Org Agenda*")))
           (buffer-list)))

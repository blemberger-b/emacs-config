...
#+begin_src emacs-lisp
  (use-package general
    ...
    :config
    (general-define-key
     :keymaps '(global flyspell-mode-map)  ;; override keymappings from other modes
     "C-;" nil) ;; need to undefine any bindings to use as a prefix
    (general-create-definer bsl/control-c-definer
      :prefix "C-c")
    (general-create-definer bsl/control-semicolon-definer
      :prefix "C-;"))
#+end_src
*** Keybindings

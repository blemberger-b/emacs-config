...
#+BEGIN_SRC emacs-lisp
  (use-package dashboard
    ...
    (dashboard-banner-logo-title
     "Learning is not just a normal work activity, it is the work.\t--Allen Holub")
...
=god=mode= is not enabled for all buffer types (e.g. magit, dashboard, etc.).
#+begin_src emacs-lisp
  ...
  (use-package god-mode
    ...
    (god-mode-all)
    :config
    (which-key-enable-god-mode-support)   ; to make this package work with which-key package

...
#+END_SRC
*** Bind ansi-tedrm command to =s-t=
...
#+begin_src emacs-lisp
  ...
  Interactively, it is given by the prefix argument."
   ...
   ; Suggested binding: `s-down'.
  (global-set-key (kbd "s-<down>") 'enlarge-frame)
#+end_src
...
#+begin_src emacs-lisp
  ...
  Interactively, it is given by the prefix argument."
   ...
   ; Suggested binding: `s-right'.
  (global-set-key (kbd "s-<right>") 'enlarge-frame-horizontally)
#+end_src
...
#+begin_src emacs-lisp
  ...
  Interactively, it is given by the prefix argument."
    (interactive "p")
    (set-frame-height frame (- (frame-height frame) increment)))
     ; Suggested binding: `s-up'.
  (global-set-key (kbd "s-<up>") 'shrink-frame)
#+end_src
...
#+begin_src emacs-lisp
    ...
    Interactively, it is given by the prefix argument."
      (interactive "p")
      (set-frame-width frame (- (frame-width frame) increment)))
     ; Suggested binding: `s-left'.
    (global-set-key (kbd "s-<left>") 'shrink-frame-horizontally)
#+end_src
*** Double Frame Width
...
*** Install & use =magit=
   ...
   to a magit command that shows the current log (commits) for the file in the current buffer.
#+begin_src emacs-lisp
  (use-package magit
   :ensure t
   :defer t

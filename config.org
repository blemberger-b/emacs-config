...
#+begin_src emacs-lisp
  (defun bsl/adjust-frame-height (op &optional increment frame)
    "Adjust the height of FRAME (default: selected-frame) by INCREMENT using OP.
  INCREMENT is in lines (characters).
  Interactively, it is given by the prefix argument."
    (if (display-graphic-p)
        (set-frame-parameter frame 'height (funcall op (frame-height frame) increment))))
  ...
  Interactively, it is given by the prefix argument."
    (interactive "p")
    (bsl/adjust-frame-height '+ increment frame))
...
#+begin_src emacs-lisp
  (defun bsl/adjust-frame-width (op &optional increment frame)
    "Adjust the width of FRAME (default: selected-frame) by INCREMENT using OP.
  INCREMENT is in lines (characters).
  Interactively, it is given by the prefix argument."
    (if (display-graphic-p)
        (set-frame-parameter frame 'width (funcall op (frame-width frame) increment))))
  ...
  Interactively, it is given by the prefix argument."
    (interactive "p")
    (bsl/adjust-frame-width '+ increment frame))
